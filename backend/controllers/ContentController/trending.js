...
const getTrendingFilms = async (req, res) => {
    try {
        ...
        const filmsResult = await pool.query("SELECT * FROM films ORDER BY views DESC LIMIT 10");
...
const getTrendingSeries = async (req, res) => {
    try {
        ...
        const seriesResult = await pool.query("SELECT * FROM series ORDER BY views DESC LIMIT 10");
